...
// Private
// Private functions
constexpr inline void TaxDistributor::CheckIncome(const std::vector<long double> &incomes) const
{
    if (incomes.empty())
        throw std::invalid_argument{"The vector income cannot be empty."};
}

const constexpr inline std::shared_ptr<std::vector<long double>> TaxDistributor::SortIncome(const std::vector<long double> &incomes) const
{
    CheckIncome(incomes);
...
constexpr inline long double TaxDistributor::CheckTaxPercentage(const long double taxPercentage) const
{
...
inline void TaxDistributor::GroupIntoIncomeGroupsAndCalculateTotalIncome()
{
...
inline void TaxDistributor::SetUpAllNeededVariables()
{
...
inline void TaxDistributor::CalculateTotalTaxAndSetTaxRemaining()
{
    totalTax = totalIncome * taxPercentage / 100;
    taxRemaining = totalTax;
}

inline void TaxDistributor::SetLastPercentileAndHighestIndividualIncome()
{
...
constexpr inline long double TaxDistributor::CalculateLowerTaxRange(const IncomeGroup &previousIncomeGroup) const
{
    return previousIncomeGroup.TaxOfIndividual();
}

constexpr inline long double TaxDistributor::CalculateUpperTaxRange(IncomeGroup &previousIncomeGroup, IncomeGroup &currentIncomeGroup) const
{
...
const constexpr inline long double TaxDistributor::CalculateTaxForIncomeGroup(const long double lowerTaxRange, const long double upperTaxRange, IncomeGroup &previousIncomeGroup, IncomeGroup &currentIncomeGroup) const
{
...
const constexpr inline void TaxDistributor::CalculateTaxesForIncomeGroups()
{
...
const constexpr inline void TaxDistributor::CalculateMoneyAfterTaxesForIncomeGroups()
{
    IncomeGroup *currentIncomeGroup;
...
// Public
// Constructors
inline TaxDistributor::TaxDistributor(const std::vector<long double> &incomes, const long double taxPercentage) : sortedIncomes{SortIncome(incomes)}, taxPercentage{CheckTaxPercentage(taxPercentage)}
{
...
// Destructor
inline TaxDistributor::~TaxDistributor()
{
}

// Public functions
const constexpr inline void TaxDistributor::DistributeTax()
{
...
const constexpr inline std::shared_ptr<std::vector<long double>> TaxDistributor::SortedIncomes() const
{
    return sortedIncomes;
}

const constexpr inline std::shared_ptr<std::vector<IncomeGroup>> TaxDistributor::IncomeGroups() const
{
    return incomeGroups;
}

const constexpr inline long double TaxDistributor::TotalIncome() const
{
    return totalIncome;
}

const constexpr inline long double TaxDistributor::TaxPercentage() const
{
    return taxPercentage;
}

const constexpr inline long double TaxDistributor::TotalTax() const
{
    return totalTax;
}

const constexpr inline long double TaxDistributor::TaxRemaining() const
{
    return taxRemaining;
}

const constexpr inline long double TaxDistributor::LastPercentile() const
{
    return lastPercentile;
}

const constexpr inline long double TaxDistributor::HighestIndividualIncome() const
{
